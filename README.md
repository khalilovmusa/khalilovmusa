...
<br/>
<div align="center">
    <img src="https://skills.syvixor.com/api/icons?i=html,css,javascript,typescript,bash,gitbash,powershell,latex,react,reactnative,nextjs,redux,bootstrap,nodejs,express,threejs,webpack,vite,vscode,github,gitlab,git,aws,netlify,postman,stackoverflow,npm,yarn,figma,windows,ubuntu,linux" />
</div>
